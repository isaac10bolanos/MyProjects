...
public class JavaFoundations {
	...
	public static void ternaryOperator() {
		...
		String result = condition % 2 == 0 
							? condition % 3 == 0 
								? condition % 4 == 0 
									? "Divisible by 4" 
									: condition % 6 == 0 // need help reading these
										? "Maybe it's 6" 
										: "not 6" 
								: "Not Divisible by 3" 
							: "Odd number";
	...
	public static void shortCircuiting() {
		...
		// the above is a short-circuit. It sees that variable == 3 and doesn't even look
	...
	public static void moreArrayLists() {
		...
		// arrays do not implement Collections interface
		...
		// ArrayList.sort() uses a Comparator and the compare interface
	...
	public static void arrayLists() {
		...
		// in the arrows I need to tell ArrayList the type of data I'm storing
		...
		// doesn't throw these on the heap like normal objects
		Integer val2 = val;
		val = 4;
		System.out.println(val);
		...
		// nums.remove(0); same if you remove the specified index
	...
	public static void innerClasses() {
		...
		// cannot make an instance of an inner class by it self
		...
		// if I import the inner class then I don't need to mention the outer one
//		Sedan.SedanColorComparator2 comparator3 = new Sedan.SedanColorComparator2();
