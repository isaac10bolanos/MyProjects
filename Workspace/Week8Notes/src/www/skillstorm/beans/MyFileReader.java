...
public class MyFileReader {
	...
	private final String txtFile = "C:\\Users\\isaac\\Documents\\Workspace\\Week8Notes\\src\\www\\skillstorm\\beans\\MyAwesomeFile.txt";
	private final String txtFile2 = "C:\\Users\\isaac\\Documents\\Workspace\\Week8Notes\\src\\www\\skillstorm\\beans\\MyAwesomeFile2.txt";
	private final String csvFile = "C:\\Users\\isaac\\Documents\\Workspace\\Week8Notes\\src\\www\\skillstorm\\beans\\MyCSV.csv";
	...
	public void readFile3() {
		...
		// can define multiple resources separated by semi-colons
...
//				BufferedReader br = new BufferedReader(fr)){
	...
	public void writeFile() {
		...
		// BufferedWriter creates the file if it doesn't exist, and overwrites it if it does
		// by default it overwrites, but if i set append to be true, then it doesn't
...
//			bw.append("Even more newer text");
	...
	public List<Person> readCSV() {
		...
		try(BufferedReader br = new BufferedReader(new FileReader(csvFile))){
			...
			line = br.readLine(); // this is the header row, the first thing in the fill
