...
public class Day5 {
	...
	public static void foreachIceCream() {
		...
		// no indexes, executes once for every value in the array (collection)
	...
	public static void icecream() {
		...
		System.out.println("***** Ice Cream *****");
//		for (int i = 0; i < flavors.length; i++) {           // setup; checks condition; increment/decrement
...
//		// there is no condition to tell it when to stop, so it doesn't
//		for (;;) {
//			if (!(j < flavors.length)) {
//				break;
//			}
