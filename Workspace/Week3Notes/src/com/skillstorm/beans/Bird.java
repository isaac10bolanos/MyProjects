...
public class Bird {
	...
	private String name; // 5 properties of a bird
	private String color;
	private boolean carnivore;
	private boolean fly;
	private double topSpeed;
	
	// Constructors are not inherited, but can still be accesses
	public Bird() { } 
	...
	public void migrate() {
		...
		// theses methods are non-static, so they can call other non-static methods
