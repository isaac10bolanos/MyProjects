...
public abstract class Motorcycle extends Vehicle{
	...
	private String brand; // these are fields or properties
	...
	public Motorcycle(String brand, String model, String color, int topSpeed,
		...
		// trike is a flag, not a field/property
		// so we don't need to encapsulate it
		if (trike) {
			setWheels(3);
		} else {
			setWheels(2);
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			// if the other thing doesn't exist, safe to say these aren't equal
			return false;
		} else if (this.getClass() != obj.getClass()) {
			// if these are two different classes, safe to say they aren't equal
			return false;
		}
		
		// Object doesn't know what a Motorcycle is
