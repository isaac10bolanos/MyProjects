...
public class Penguin extends Bird{
	...
	// the final keyword on methods, stops the method form being overridden
	public final void dance() {
		System.out.println(getName() + " has happy feet");
	}
	
	public void slide(double distance) {
		System.out.println(getName() + " slid " + distance + " miles, majesticly!");
	}
	...
	public void migrate() {
		...
		System.out.println(getName() + 
				" is in the zone. It dances accross the land at " + getTopSpeed() +
				" mph");
	}
