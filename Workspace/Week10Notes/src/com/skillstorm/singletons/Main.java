...
//		System.out.println("Main ring: " + theRing);
		...
		threadSafeSingletonInThreads();
	}
	
	public static void threadSafeSingletonInThreads() {
		...
		Thread thread3 = new Thread(() -> {
			TrueRingOfPower ring3 = TrueRingOfPower.getInstance();
	...
	public static void threadSafeSingletons() {
		// this is still single threaded as I've written it
		for(int i = 0; i < 3; i++) {
