...
public class Main {
	 ...
	 *  				 (example:/"this will succeed if this thread is faster")
	 *  
	 *  deadlocks: two or more threads are blocked, waiting on a resource 
	 *  		   another thread holds. They wait forever
	 *  
	 *  starvation: a thread is unable to access a resource it needs to continue it's 
	 *  		    process, so it gets stuck (2nd grader vs 6th grader)
	 *  
	 ...
	 *  		   (stuck in a traffic circle)
	 */
	
	// a design pattern involving two or more threads,
	// at least one producer and at least one consumer
	// the producer thread/threads produce some data
	// the consumer thread/threads consume that data
	public static void main(String[] args) {
		// our producer and consumer will produce / consume a random amount of data
