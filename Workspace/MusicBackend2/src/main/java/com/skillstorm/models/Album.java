...
//	private String artist;
	...
	public String toString() {
		return "Album [albumId=" + this.albumId + ", title=" + this.title + ", artist=" + this.artist + ", genre=" + this.genre + ", label="
				+ this.label + ", trackCount=" + this.trackCount  + ", imageUrl=" + this.imageUrl+ "]";
	}
