...
public class OCA {
	...
	public static void lambdas() {
		...
		// lambda is an anonymous method denotes by ->
		...
		Predicate<List<String>> danPresent = strs -> strs.contains("Dan");
		
		// for lambdas I can include any amount of code, but if it's a one liner I don't
		// need curly braces
...
//			System.out.print(d);
	...
	public static void dates() {
		// in Java, and most languages Dates and Time are their own data types
		// Java has a Date data type but most of it is deprecated in favor of LocalDate
		
		// Dates are immutable under java.util
		...
		System.out.println(localToday); // under java.time
		...
		// Same as Strings
		LocalDate twoDays = localToday.plusDays(2); // need to save the value or I can't reference
		...
		// once includes the time and one doesn't 
		// LocalDate has no time
		
		System.out.println();
		System.out.println("***** Local Date Time *****");
		// no public constructor for this too
		LocalDateTime todayTime = LocalDateTime.now(); // under java.time
		...
		// if you want to change how your date prints, you use a DatetimeFormatter    // kk:mm is military
	...
	public static void recursionExamples() {
		...
		System.out.println(recursive.interativeSum(20));
		System.out.println(recursive.interativeSum(50));
		System.out.println(recursive.interativeSum(77));
...
//	class B (extends A
	...
	public static void enumTypes() {
		...
		// they also function very similarly to classes though most do not use them as 
		// a class
	...
	public static void multiDimensionalLists() {
		...
		myNums.get(0).add(4); // added to index 0, 0
		System.out.println(myNums);
		
		// this is what you want to use
		// I can see that this is a 10 x 10 array
		// I can see that, that won't change easily
		int[][] myNums2 = new int[10][10];
		System.out.println(myNums2[9]);
		myNums2[0][0] = 4;
		
		// where I would want to use a List over an array
		// nissanInventory essentially makes named buckets, in those buckets I throw
		// cars that I have on me
		Map<String, ArrayList<Sedan>> nissanInventory = new HashMap<>();
		nissanInventory.put("Altima", new ArrayList<Sedan>()); // now I have a spot to put altimas
...
//		nissanInventory.get("Maxima").add(maxima1);
		...
		for(Map.Entry<String, ArrayList<Sedan>> entry : nissanInventory.entrySet()) {
			...
			for(Sedan car : entry.getValue()) {
				...
				// to lower case so that I don't need to worry about the case
