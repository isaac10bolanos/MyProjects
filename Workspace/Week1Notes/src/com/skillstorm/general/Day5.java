...
public class Day5 {
	...
	public static void main(String[] args) {
		...
		// can negate anything will !, so in this case is topping isnt anchovies
		...
		if (topping.equalsIgnoreCase("Pinapple")) {
			weight = 2;
			System.out.println(weight);
		}
		...
		int val = 10;
		// if statements use {} to show which lines of code with the if
		...
		if (!topping.equalsIgnoreCase("Anchovies")) {
			...
			System.out.println("All of a sudden I don't want pizza");
		}
		...
		if (topping.equalsIgnoreCase("Pepperoni")) {
			weight2 = 1;
		} else if (topping.equalsIgnoreCase("Pinapple")) {
			weight2 = 2;
		...
		if (variable > 23) {
			...
			System.out.println("Value is 27!"); // this won't execute
		}else {
		...
		if (variable >= 20) {
			...
			if (variable >= 0) {
				System.out.println("At least it's positive");
			}else {
