...
public class Day4 {
	...
	public static void main(String[] args) {
		...
		// ceil and floor
		// ceil round up (your ceiling is above you)
		...
		System.out.println(Math.ceil(2.4)); // prints 3
		System.out.println(Math.floor(2.4)); // prints 2
		...
		String lowerCase = firstName.toLowerCase(); // makes a new string
		
		System.out.println(firstName.toLowerCase()); // prints in lowercase
		System.out.println(firstName); // original is unchanged
		System.out.println(lowerCase); // a different string, that is lowercase
		...
		System.out.println(name1 == name2); // does not always work for string comparison
		System.out.println(name1.equals(name2)); // "prefer" should always use this for strings, this looks at the value
