...
public class Day3 {
	...
	public static void main(String [] args) {
		...
		// I can add, multiply, divide, subtract whole numbers and
		...
		// 7 + 6 - 2
		// 13 - 2 = 11 because integers always return and integer
		...
		// narrow cast. going from a dobule (larger) to a short (smaller)
		shortResult = (short)((double)int1 + int2 - short1 * int1 + short1 / byte1);
		
		System.out.println(shortResult);
		
		// 7 - 6 * 5 + 3.1416 / 45.352 * 2 = about -22.8614
		// 7 - 30 + 3.1416 / 45.352 * 2
		// 7 - 30 + 0.692 * 2
		// 7 - 30 + 0.138
		// -23  0.138 = about -22.861
		...
		// check your numbers to make sure they aren't zero before dividing
