...
// they are built separately. You don't ship your tests with your code
public class MovieTest {
	...
	public void setup() {
		...
		// this creates this new action movie just before each of the below tests run
	...
	public void checkAdmission() {
		...
		// if the assertion passes then your test passes, 
		// if the assertion fails, your test also fails
	...
	// the order that Test methods run in is not guaranteed
	...
	// can have multiple before and after methods, but the order is not guaranteed
	@After
